...
async function main(params) {
  ...
  try {
    ...
    return {
      statusCode: 200,
      body: { overlayUrl: `${baseUrl}-public/public/pdps`, parseCSVUrl: `${presignUrl}`, parseCSVTargetUrl: `${presignTargetUrl}`,  parseCSVUrlJP: `${presignUrlJP}`, parseCSVTargetUrlJP: `${presignTargetUrlJP}`}
    };
  } catch (error) {
